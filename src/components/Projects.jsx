...
const Projects = () => {
    const projects = [
    {
      ...
      liveLink: 'https://image-enhancer-theta.vercel.app/',
      sourceLink: 'https://github.com/Dhruvsahu1/Image-Enhancer'
    },
      {
        title: 'Project Management App',
        description: 'A collaborative task management application with real-time updates, drag-and-drop functionality, and team collaboration features. Built with React, Socket.io, Node.js, and MongoDB.',
        technologies: ['React', 'Socket.io', 'Node.js', 'MongoDB'],
        image: 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=500&h=300&fit=crop',
        liveLink: '#',
        sourceLink: 'https://github.com/Dhruvsahu1/chitchat'
      },
      {
        ...
        liveLink: '#',
        sourceLink: 'https://github.com/Dhruvsahu1/App-Weather-Mern'
      }
  ]
  ...
  return (
    <section id="projects" className="py-20 bg-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <a
            href="https://github.com/Dhruvsahu1"
            target="_blank"
            rel="noopener noreferrer"
